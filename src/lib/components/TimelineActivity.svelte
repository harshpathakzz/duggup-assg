...
<section class="relative flex items-center">
	...
	<!-- SVG -->
	<svg width="31" height="288" viewBox="0 0 31 288" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="flex flex-row flex-wrap items-start justify-start gap-10">
		{#each cards as { imageSrc, altText, content }}
			<ImageCard {imageSrc} {altText} {content} />
		{/each}
	</div>
</section>
